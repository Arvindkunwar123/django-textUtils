...
class Pipe:
    ...
    @staticmethod
    def index(request):
        return HttpResponse(render(request, "utility/index.html"))
    ...
    def analyse(self, request):
        ...
        return render(request, "utility/analyse.html", results)

    @staticmethod
    def handler404(request):
        return HttpResponse(render(request, "utility/404.html"))
